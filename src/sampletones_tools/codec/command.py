...
STUDY_HELP: Final[str] = "encode the projects and stems named under every candidate change, with a verdict each"
MANIFEST_HELP: Final[str] = (
    "a manifest a run wrote, measured again; its lengthening and variants stand in for the options below"
)
PROJECT_HELP: Final[str] = (
    "a project file to measure, repeatable; a run names at least one project, reconstruction or manifest"
)
RECONSTRUCTION_HELP: Final[str] = (
    "a stem file, or a directory of stems, to measure, repeatable; named sources replace a manifest's own"
)
