from sampletones_core.bitphase.specification.instruments import INSTRUMENT_ID_DIGITS
from sampletones_core.bitphase.specification.patterns import SYMBOL_BASE, SYMBOL_DIGITS
