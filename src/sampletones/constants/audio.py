...
SAMPLE_RATES: Final[List[SampleRate]] = cast(List[SampleRate], SampleRate.__args__)

BufferSize = Literal[64, 128, 256, 512, 1024, 2048, 4096, 8192]
BUFFER_SIZES: Final[List[BufferSize]] = cast(List[BufferSize], BufferSize.__args__)
