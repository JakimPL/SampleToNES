...
from ..constants import (
    ...
    VAL_BAR_PLOT_MAX_DUTY_CYCLE_Y,
    VAL_BAR_PLOT_MAX_PITCH_Y,
    VAL_BAR_PLOT_MAX_VOLUME_Y,
    VAL_BAR_PLOT_MIN_DUTY_CYCLE_Y,
    VAL_BAR_PLOT_MIN_PITCH_Y,
    VAL_BAR_PLOT_MIN_VOLUME_Y,
)
...
FEATURE_PLOT_CONFIGS: Dict[FeatureKey, FeaturePlotConfig] = {
    FeatureKey.VOLUME: FeaturePlotConfig(
        ...
        y_min=VAL_BAR_PLOT_MIN_VOLUME_Y,
        y_max=VAL_BAR_PLOT_MAX_VOLUME_Y,
        y_ticks=(0, 4, 8, 12, 16),
    ),
    ...
    FeatureKey.PITCH: FeaturePlotConfig(
        ...
        y_min=VAL_BAR_PLOT_MIN_PITCH_Y,
        y_max=VAL_BAR_PLOT_MAX_PITCH_Y,
    ...
    FeatureKey.DUTY_CYCLE: FeaturePlotConfig(
        ...
        y_min=VAL_BAR_PLOT_MIN_DUTY_CYCLE_Y,
        y_max=VAL_BAR_PLOT_MAX_DUTY_CYCLE_Y,
        y_ticks=(0, 1, 2, 3),
    ),
}
