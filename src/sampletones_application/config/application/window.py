...
class WindowState(BaseModel):
    width: int = Field(default=DIM_WINDOW_WIDTH, description="The width of the main application window.")
    height: int = Field(default=DIM_WINDOW_HEIGHT, description="The height of the main application window.")
