        ...
        cls._theme = ThemeItems(
            items={
                ThemeParameter(item_type=dpg.mvButton, enabled_state=False): [
                    ...
                    ThemeColor(key=dpg.mvThemeCol_Text, color=c.text.disabled, category=dpg.mvThemeCat_Core),
                    ...
                    ThemeColor(key=dpg.mvThemeCol_MenuBarBg, color=c.backgrounds.menu, category=dpg.mvThemeCat_Core),
                ],
            }
        )
