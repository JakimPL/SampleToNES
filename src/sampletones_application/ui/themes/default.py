        ...
        cls._theme = ThemeItems(
            items={
                ThemeParameter(item_type=dpg.mvAll): [
                    ...
                    ThemeColor(key=dpg.mvThemeCol_WindowBg, color=c.backgrounds.default),
                    ThemeColor(key=dpg.mvThemeCol_ChildBg, color=c.backgrounds.default),
                    ThemeColor(key=dpg.mvThemeCol_PopupBg, color=c.backgrounds.menu),
                    ThemeColor(key=dpg.mvThemeCol_MenuBarBg, color=c.backgrounds.menu),
                ],
                ThemeParameter(item_type=dpg.mvMenuBar, enabled_state=True): [
                    ThemeColor(key=dpg.mvThemeCol_MenuBarBg, color=c.backgrounds.menu),
                ],
                ThemeParameter(item_type=dpg.mvButton, enabled_state=True): [
                    ThemeColor(key=dpg.mvThemeCol_Button, color=c.buttons.default),
                    ThemeColor(key=dpg.mvThemeCol_ButtonHovered, color=c.buttons.hovered),
                    ThemeColor(key=dpg.mvThemeCol_ButtonActive, color=c.buttons.active),
                    ThemeStyle(key=dpg.mvStyleVar_FrameRounding, x=b.frame_rounding),
                    ThemeStyle(
                ...
                ThemeParameter(item_type=dpg.mvTable, enabled_state=True): [
                    ThemeColor(key=dpg.mvThemeCol_TableHeaderBg, color=c.tables.header),
                    ThemeColor(key=dpg.mvThemeCol_TableRowBg, color=c.tables.row),
                    ThemeColor(key=dpg.mvThemeCol_TableRowBgAlt, color=c.tables.row_alternative),
                    ThemeColor(key=dpg.mvThemeCol_TableBorderStrong, color=c.tables.border),
                    ThemeColor(key=dpg.mvThemeCol_TableBorderLight, color=c.tables.border),
                ],
                ...
                ThemeParameter(item_type=dpg.mvRadioButton, enabled_state=False): [
                    ThemeColor(key=dpg.mvThemeCol_Text, color=c.text.disabled),
                ],
