...
PARTIAL_CHANNEL_THEME_TAGS: Final[Dict[ChannelName, str]] = {
    ChannelName.PULSE1: TAG_GLOBAL_THEME_CHANNEL_PULSE1_PARTIAL,
    ChannelName.PULSE2: TAG_GLOBAL_THEME_CHANNEL_PULSE2_PARTIAL,
    ChannelName.TRIANGLE: TAG_GLOBAL_THEME_CHANNEL_TRIANGLE_PARTIAL,
    ChannelName.NOISE: TAG_GLOBAL_THEME_CHANNEL_NOISE_PARTIAL,
}
