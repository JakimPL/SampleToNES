...
OMISSION_ELEMENTS: Final[Dict[InstrumentOmission, SequencerVoicesElements]] = {
    InstrumentOmission.PITCH: SequencerVoicesElements.OMISSION_PITCH,
...
class InstrumentImportMessages:
    ...
    A ``.fti`` states a channel's whole instrument, and a voice takes the three envelopes every
    channel here plays. Whatever the file states past them stays in the file, so the import names
    it in the reader's own words as the voice arrives.
