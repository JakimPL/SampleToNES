...
class InstructionsLibraryElements(AbstractElement):
    ...
    CONTEXT_REMOVE_LIBRARY = "context_remove_library"
    STATUS_GENERATE = "status_generate"
    STATUS_CANCEL_GENERATION = "status_cancel_generation"
    ...
    REMOVE_LIBRARY_DIALOG = "remove_library_dialog"
    REMOVE_LIBRARY_MESSAGE = "remove_library_message"
