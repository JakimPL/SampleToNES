...
class InstructionsLibraryElements(AbstractElement):
    ...
    REBUILD_LIBRARY_BUTTON = "rebuild_library_button"
    ...
    REBUILD_CONFIRMATION_DIALOG = "rebuild_confirmation_dialog"
    REBUILD_CONFIRMATION_MESSAGE = "rebuild_confirmation_message"
    REBUILD_CONFIRMATION_OK = "rebuild_confirmation_ok"
    ...
    LIBRARY_NODE_OUTDATED_TEMPLATE = "library_node_outdated_template"
