...
TAG_GLOBAL_THEME_COLLAPSE_HEADER = TagName(
    Page.GLOBAL,
    Panel.IMPLICIT,
    Widget.THEME,
    "collapse_header",
)
TAG_GLOBAL_THEME_COLLAPSE_HEADER_HOVERED = TagName(
    Page.GLOBAL,
    Panel.IMPLICIT,
    Widget.THEME,
    "collapse_header_hovered",
)
...
TAG_GLOBAL_THEME_PANEL_EMPHASIS = TagName(
    Page.GLOBAL,
    Panel.IMPLICIT,
    Widget.THEME,
    "panel_emphasis",
...
TAG_GLOBAL_THEME_INSTRUMENT_TABS = TagName(
    Page.GLOBAL,
    Panel.IMPLICIT,
    Widget.THEME,
    "instrument_tabs",
...
SUF_HANDLER_DIALOG_NAV = f"{TAG_SEPARATOR}handler{TAG_SEPARATOR}dialog_nav"
