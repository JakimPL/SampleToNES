...
SUF_GROUP_RAW_DATA = ".group.raw_data"
...
SUF_HANDLER_MOUSE = ".handler.mouse"
SUF_BUTTON_RESET_X = f"{SUF_BUTTON}.reset_x"
SUF_BUTTON_RESET_Y = f"{SUF_BUTTON}.reset_y"
SUF_BUTTON_RESET_ALL = f"{SUF_BUTTON}.reset_all"
