...
DIM_PANEL_CONFIG_WIDTH = 340
DIM_PANEL_CONFIG_HEIGHT = 260
DIM_PANEL_LIBRARY_WIDTH = 340
DIM_PANEL_LIBRARY_HEIGHT = -1
DIM_PANEL_RECONSTRUCTOR_HEIGHT = 324
DIM_PANEL_RECONSTRUCTOR_WIDTH = 340
DIM_PANEL_BROWSER_WIDTH = 360
...
LBL_RECONSTRUCTION_PITCH_PLOT = "Pitch (HI_PITCH)"
...
LBL_BAR_PLOT_FRAME_LABEL = "Frame"
...
VAL_BAR_PLOT_BAR_WEIGHT = 1.0
DIM_BAR_PLOT_DEFAULT_HEIGHT = 300
