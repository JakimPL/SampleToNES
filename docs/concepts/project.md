...
channels, together with the voices it is built from. Where a
[reconstruction](reconstruction.md) is a single converted sound, a project holds
many of them, the instruments written by hand beside them, and the arrangement that
plays them all, so an entire piece lives as one file.
