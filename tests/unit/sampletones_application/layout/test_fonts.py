...
SANS: Final[FontScale] = FontScale(tiny=10, small=11, medium=12, large=13, title=14)
MONO: Final[FontScale] = FontScale(tiny=20, small=21, medium=22, large=23, title=24)
ICON: Final[FontScale] = FontScale(tiny=30, small=31, medium=32, large=33, title=34)
...
class TestTheSizeLadder:
    ...
    def test_every_rung_answers_with_the_size_the_scale_states(self) -> None:
        assert [SANS.step(step) for step in Step] == [10, 11, 12, 13, 14]
