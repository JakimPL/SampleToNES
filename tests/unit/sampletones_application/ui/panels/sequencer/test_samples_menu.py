...
FOOTPRINT = SampleFootprintViewModel(
    instruments=(
        InstrumentSizeViewModel(generator=GeneratorName.PULSE1, total_bytes=PULSE_1_BYTES),
        InstrumentSizeViewModel(generator=GeneratorName.NOISE, total_bytes=NOISE_BYTES),
    ),
)
