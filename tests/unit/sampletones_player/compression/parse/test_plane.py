...
class TestTheParseCoversThePlaneCheaply:
    ...
    def test_the_cost_of_the_whole_plane_is_the_cost_of_its_tokens(
        self,
    ) -> None:
    ...
    def test_a_run_reaches_the_stream_as_a_hold(self) -> None:
        ...
        assert parse.tokens == (
            LiteralToken(values=bytes((7,))),
            HoldToken(ticks=39),
        )

    def test_a_run_longer_than_one_hold_reaches_the_stream_as_several(
        self,
    ) -> None:
    ...
    def test_a_figure_the_dictionary_holds_reaches_the_stream_as_a_phrase(
        self,
    ) -> None:
    ...
    def test_a_phrase_the_layer_switches_off_is_spelled_out_instead(
        self,
    ) -> None:
...
class TestABoundaryIsATickATokenStartsOn:
    ...
    def test_a_boundary_is_reached_by_a_token_stating_its_own_value(
        self,
    ) -> None:
