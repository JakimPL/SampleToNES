...
from sampletones_tools.checks import rendered_literals as check_rendered_literals
...
class TestMain:
    def test_no_case_in_the_repository_holds_rendered_text_against_a_literal(self) -> None:
        assert dispatch(COMMANDS, ["check", "rendered-literals"]) == 0
    ...
    def test_a_case_that_does_is_reported_where_it_sits(
        ...
        exit_code = dispatch(COMMANDS, ["check", "rendered-literals", "--tests", str(cases)])
