...
from sampletones_tools.checks import unused_tags as check_unused_tags
...
class TestMain:
    def test_the_repository_reads_every_fragment_it_declares(self) -> None:
        assert dispatch(COMMANDS, ["check", "unused-tags"]) == 0
    ...
    def test_an_unread_fragment_is_reported_where_it_sits(
        ...
        exit_code = dispatch(COMMANDS, ["check", "unused-tags", "--tags", str(tags), "--reference-root", str(sources)])
